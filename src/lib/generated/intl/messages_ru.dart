...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "achievementName" : MessageLookupByLibrary.simpleMessage("Название"),
    "achievementOwnerTitle" : MessageLookupByLibrary.simpleMessage("Владелец"),
    "achievementStatisticsTitle" : MessageLookupByLibrary.simpleMessage("Статистика"),
    "achievementStatisticsTooltip" : MessageLookupByLibrary.simpleMessage("Как много людей уже получили эту награду"),
    ...
    "addedPeople" : MessageLookupByLibrary.simpleMessage("Добавленные люди"),
    "admins" : MessageLookupByLibrary.simpleMessage("Администраторы"),
    "allAchievements" : MessageLookupByLibrary.simpleMessage("Все награды"),
    "appName" : MessageLookupByLibrary.simpleMessage("Kudos"),
    "cancel" : MessageLookupByLibrary.simpleMessage("Отмена"),
    "chooseTeam" : MessageLookupByLibrary.simpleMessage("Выберите команду"),
    ...
    "sentSuccessfully" : MessageLookupByLibrary.simpleMessage("Награда успешно отправлена!"),
    ...
    "transferAchievementToTeamWarning" : MessageLookupByLibrary.simpleMessage("Вы хотите сменить владельца этой награды на команду %s? Вы можете потерять доступ к этой награде после завершения данной операции"),
    "transferAchievementToUserWarning" : MessageLookupByLibrary.simpleMessage("Вы хотите сменить владельца этой награды на %s? Вы можете потерять доступ к этой награде после завершения данной операции"),
