...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "transferAchievementToUserWarning" : MessageLookupByLibrary.simpleMessage("Вы хотите сменить владельца этой награды на %s? Вы потеряете доступ к этой награде после завершения данной операции"),
